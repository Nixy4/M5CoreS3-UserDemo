...
void bsp_display_buf_swap(uint16_t* buf, size_t w, size_t h)
{
...
static SemaphoreHandle_t camera_lock = NULL;
static volatile TickType_t camera_last_frame_tick = 0;

esp_err_t bsp_camera_init(framesize_t framesize)
{	
	//初始化互斥锁
...
void bsp_camera_fb_return(camera_fb_t *frame)
{
